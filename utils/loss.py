...
'''
交叉熵函数
@:param nbclasses：结果有多少种分类
@:param inputs：net的结果输入
...
class MySoftmaxCrossEntropyLoss(nn.Module):
    ...
    def forward(self, inputs, target):
        ...
        # 注意target的值不能大于nbclasses https://discuss.pytorch.org/t/crossentropyloss-expected-object-of-type-torch-longtensor/28683
